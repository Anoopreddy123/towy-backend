...
export class EmailService {
    ...
    public async sendServiceRequestNotification(
    ...
    public async sendBulkServiceRequestNotifications(
    ...
    private generateServiceRequestEmailHTML(provider: ProviderDetails, serviceRequest: ServiceRequestDetails): string {
    ...
    private generateServiceRequestEmailText(provider: ProviderDetails, serviceRequest: ServiceRequestDetails): string {
        const businessName = provider.businessName || provider.name;
        const serviceTypeFormatted = serviceRequest.type.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase());
